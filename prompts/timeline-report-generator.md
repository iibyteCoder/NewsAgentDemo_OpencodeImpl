...
2. ⭐⭐⭐ **严格遵循模板格式** - 参考 `templates/sections/timeline-section-template.md`
3. ⭐⭐⭐ **按时间顺序排列** - 从早到晚，使用日期排序
4. ⭐⭐⭐ **每个时间节点必须包含来源链接** - 从数据的 sources 字段提取
5. ⭐⭐ **正确标注重要性** - 使用 ⭐ 符号和文字说明
6. ⭐ **完整呈现数据** - 不要省略输入中的任何重要信息
7. ⭐ **体现因果关系** - 在描述中说明前后事件的关联
